<template>
  <div>
    ...
    >
      <b-card-text>
        Enter either a repository keyword or the name of a data repository to
        find examples of the data in use!
      </b-card-text>
      <div>
        <b-form-group label="Search Resource">
          <b-form-radio v-model="selected" name="some-radios" value="A"
            >Data Catalog</b-form-radio
          >
          <b-form-radio v-model="selected" name="some-radios" value="B"
            >Code Repository</b-form-radio
          >
        </b-form-group>
      </div>
      ...
      <b-form inline @submit="onSubmit" @reset="onReset" v-if="show">
        ...
        <label class="sr-only" for="inline-form-input-limits"
          >Return Limit</label
        >
        <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
          <b-form-select
