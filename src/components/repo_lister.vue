...
<div>
  <b-container fluid>
    <b-row>
      <b-col cols='3'>
        <b-button v-b-modal.repocitation @click="getCite(apikw)" align="right">Get Citations</b-button>
      </b-col>
      <b-col cols='5'>
        <b-form-checkbox id="checkboxrepo"
                         ...
                         v-b-tooltip.hover title="Unselected resources will be placed at the end of the list.">
        ...
        <b-container fluid>
          <b-row align-v="center">
            ...
            <b-col class="col-md-10">
              <h4><a v-bind:href="item.url" rel="noopener noreferrer" target="_blank">{{item.name}}</a>&nbsp;
